...
const CURRICULUM_DATA = {
  info: {
    programName: 'M. Tech Mechatronics',
    programCategory: 'PG',
    programBeginYear: '2020'
  },
  workingCurriculums: [
    {
...
const MTechMECHView = ({ onBack }) => {
  const [activeTab, setActiveTab] = useState('info');

  const renderInfo = () => (
    <div className="curriculum-info">
      <h2 className="curriculum-title">M. Tech Mechatronics</h2>
