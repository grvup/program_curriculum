...
import MTechCSEView from './MTechCSEView.js';
import PhDCSEView from './PhDCSEView.js';
import BTechCSEView from './BTechCSEView.js';
import CourseProposalForm from './CourseProposalForm.js';
...
<aside className={`sidebar ${isSidebarOpen ? 'open' : 'closed'}`}>
  ...
  <nav className="sidebar-nav">
    <ul>
      <li><a href="/home" onClick={() => handleNavClick('disciplines')}><Home size={20} /> {isSidebarOpen && 'Home'}</a></li>
