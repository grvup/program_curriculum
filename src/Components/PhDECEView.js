  ...
  workingCurriculums: [
    {
      ...
      version: '1.0',
      batch: ['PhD ECE 2016', 'PhD ECE 2017', 'PhD ECE 2018', 'PhD ECE 2019', 'PhD ECE 2020', 'PhD ECE 2021'],
      semesters: 4
    }
  ]
};

const PhDECEView = ({ onBack }) => {
  const [activeTab, setActiveTab] = useState('info');

  const renderInfo = () => (
    <div className="curriculum-info">
      <h2 className="curriculum-title">PhD in ECE</h2>
